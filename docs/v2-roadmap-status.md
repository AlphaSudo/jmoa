...
three-service V1-to-V2 launch gate was also executed. Patient is now confirmed
...
V2-C/V2-D confirmation. Application-CDS failures remain authoritative for
those archive policies. The aggregate is therefore policy-selected, not a
universal CDS claim, and remains distinct from the narrower `READY_FOR_RC2`
qualification for the scoped public PetClinic claim.
